...
import { ImageBackground, StyleSheet, Text, View, Image, TextInput, KeyboardAvoidingView } from 'react-native'
...
const Home = () => {
  ...
  function handleNavigationTo(Dest: string) {
